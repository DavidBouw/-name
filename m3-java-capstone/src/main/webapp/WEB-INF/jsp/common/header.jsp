...
<body>
    ...
    <nav>
        ...
        <ul>
            <li><a href="alien_age">Alien Age</a></li>
            <li><a href="alien_weight">Alien Weight</a></li>
            <li><a href="alien_drive_time">Drive Time</a></li>               
            <li><a href="alien_bulletin_list">Bulletins</a></li>               
            <li><a href="alien_products">Products</a></li>               
        </ul>
    </nav>